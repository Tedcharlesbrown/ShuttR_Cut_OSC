//--------------------------------------------------------------
// B_imagePage.h && B_imagePage.mm
//--------------------------------------------------------------

//--------------------------------------------------------------
// MARK: ---------- IMAGE PAGE - SETUP / UPDATE / DRAW ----------
//--------------------------------------------------------------
...
void imagePageTouchDown() {
	if (hasGobo1) { gobo1Button.touchDown(true); }
	if (hasGobo2) { gobo2Button.touchDown(true); }
	if (hasGobo3) { gobo3Button.touchDown(true); }
	if (hasBeam1) { beam1Button.touchDown(true); }
	if (hasBeam2) { beam2Button.touchDown(true); }
	if (hasBeam3) { beam3Button.touchDown(true); }
	if (hasAni1) { ani1Button.touchDown(true); }
	if (hasAni2) { ani2Button.touchDown(true); }
	if (hasAni3) { ani3Button.touchDown(true); }
	if (hasColor1) { color1Button.touchDown(true); }
	if (hasColor2) { color2Button.touchDown(true); }
	if (hasColor3) { color3Button.touchDown(true); }

	minusPercentButton.touchDown();
	homeButton.touchDown();
	plusPercentButton.touchDown();

	minusSpeedButton.touchDown();
	homeSpeedButton.touchDown();
	plusSpeedButton.touchDown();
}

//--------------------------------------------------------------
void imagePageTouchMoved() {
}

//--------------------------------------------------------------
void imagePageTouchUp() {
	minusPercentButton.touchUp();
	homeButton.touchUp();
	plusPercentButton.touchUp();

	minusSpeedButton.touchUp();
	homeSpeedButton.touchUp();
	plusSpeedButton.touchUp();
}

//--------------------------------------------------------------
void imagePageDoubleTap() {
	homeButton.touchDoubleTap();
	homeSpeedButton.touchDoubleTap();
}